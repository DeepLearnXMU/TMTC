...
def get_data_reader(model_name, max_len, skip_correct=False, skip_complex=0,
                    test_mode=False, tag_strategy="keep_one", first_type="random",
...
def main(args):
    ...
    # read datasets
    reader = get_data_reader(f'{prefix_dir}/{weights_name}', args.max_len, skip_correct=bool(args.skip_correct),
    ...
    model = get_model(f'{prefix_dir}/{weights_name}', vocab,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tag_strategy',
                        ...
                        default='keep_one')
    parser.add_argument('--first_type',
                        choices=['random', 'delete', 'append', 'replace'],
                        help='The type of the data trained in the first turn.',
                        default='random')
